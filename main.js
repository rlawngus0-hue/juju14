document.addEventListener('DOMContentLoaded', () => {
    ...
    const menus = [
        ...
        { name: '삼겹살', category: 'KOREAN', img: 'https://images.unsplash.com/photo-1598515214211-89d3c73ae83b?w=500&q=80' },
        ...
        { name: '김치찌개', category: 'KOREAN', img: 'https://images.unsplash.com/photo-1627308595229-7830a5c91f9f?w=500&q=80' },
        { name: '파스타', category: 'WESTERN', img: 'https://images.unsplash.com/photo-1516100882582-96c3a05fe590?w=500&q=80' },
        { name: '돈카츠', category: 'JAPANESE', img: 'https://images.unsplash.com/photo-1591814468924-caf88d1232e1?w=500&q=80' },
        ...
        { name: '보쌈', category: 'KOREAN', img: 'https://images.unsplash.com/photo-1623961990059-28355e22c889?w=500&q=80' },
        { name: '쌀국수', category: 'ASIAN', img: 'https://images.unsplash.com/photo-1582878826629-29b7ad1cdc43?w=500&q=80' },
        { name: '텐동', category: 'JAPANESE', img: 'https://images.unsplash.com/photo-1615361200141-f4500043e957?w=500&q=80' },
        { name: '라멘', category: 'JAPANESE', img: 'https://images.unsplash.com/photo-1569718212165-3a8278d5f624?w=500&q=80' },
        { name: '스테이크', category: 'WESTERN', img: 'https://images.unsplash.com/photo-1600891964599-f61ba0e24092?w=500&q=80' },
        ...
        { name: '감바스', category: 'WESTERN', img: 'https://images.unsplash.com/photo-1559742811-822873691df8?w=500&q=80' }
    ];
